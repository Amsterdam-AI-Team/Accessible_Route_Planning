...
def write_las(points, las_path, labels=None, inclination=None):
    """
    ...
    if inclination is not None:
        outfile.add_extra_dim(laspy.ExtraBytesParams(name="dip", type="uint16",
                              description="dip (degrees)"))
        outfile.dip = inclination
